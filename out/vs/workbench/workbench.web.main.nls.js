 ...
 * Copyright (c) Microsoft Corporation. All rights reserved.
 *--------------------------------------------------------*/
define("vs/workbench/workbench.web.main.nls", {
	...
	"vs/workbench/browser/workbench.contribution": [
		...
		"The template which should be rendered when the pattern mtches. May include the variables ${dirname}, ${filename} and ${extname}.",
		...
		"Controls the location of the Activity Bar. It can either show to the `default` or `top` / `bottom` of the Primary and Secondary Side Bar or `hidden`.",
		"Show the Activity Bar of the Primary Side Bar on the side.",
		"Show the Activity Bar on top of the Primary and Secondary Side Bar.",
		"Show the Activity Bar at the bottom of the Primary and Secondary Side Bar.",
		"Hide the Activity Bar in the Primary and Secondary Side Bar.",
	...
	"vs/workbench/contrib/accessibility/browser/accessibilityConfiguration": [
		"This setting is deprecated. Use the `signals` settings instead.",
		"Accessibility",
		...
		"Indicates when a file is saved. Also see {0}.",
		"Indicates when a file is saved via user gesture.",
		"Indicates whenever is a file is saved, including auto save.",
		"Never alerts.",
		"Indicates when a feature is cleared (for example, the terminal, Debug Console, or Output channel). Also see {0}.",
		"Indicates when a file or notebook cell is formatted. Also see {0}.",
		...
		"Never alerts.",
		"Indicates when the debugger breaks. Also see {0}.",
		"Indicates when the active line has an error. Also see {0}.",
		"Indicates when the active line has a warning. Also see {0}.",
		"Indicates when the active line has a folded area that can be unfolded. Also see {0}.",
		"Indicates when there is an available terminal quick fix. Also see {0}.",
		"Indicates when the terminal bell is activated.",
		"Indicates when a terminal command fails (non-zero exit code). Also see {0}.",
		"Indicates when a task fails (non-zero exit code). Also see {0}.",
		"Indicates when a task completes successfully (zero exit code). Also see {0}.",
		"Indicates when a chat request is sent. Also see {0}.",
		"Indicates when a chat response is pending. Also see {0}.",
		"Indicates when there are no inlay hints. Also see {0}.",
		"Indicates when on a line with a breakpoint. Also see {0}.",
		"Indicates when a notebook cell completes successfully. Also see {0}.",
		"Indicates when a notebook cell fails. Also see {0}.",
		"Indicates when the debugger breaks. Also see {0}.",
		...
		"Indicates when a terminal command fails (non-zero exit code).",
		...
		"Alerts on loop while the response is pending.",
		...
		"Indicates when a feature is cleared.",
		...
		"The language that voice speech recognition should recognize. Select `auto` to use the configured display language if possible. Note that not all display languages maybe supported by speech recognition",
	...
	"vs/workbench/contrib/codeEditor/browser/diffEditorHelper": [
		...
		"Run the command Diff Editor: Switch Side, which is currently not triggerable via keybinding, to toggle between the original and modified editors.",
	...
	"vs/workbench/contrib/inlineChat/browser/inlineChatActions": [
		...
		"Regenerate Response",
		"Regenerate",
		"Regenerate without Command Detection",
		"Cursor Up",
		"Cursor Down",
		"Discard",
		"Discard...",
	...
	"vs/workbench/contrib/inlineChat/browser/inlineChatFileCreationWidget": [
		"Create",
		"Create As",
		"Discard"
	],
	...
	"vs/workbench/contrib/inlineChat/browser/inlineChatStrategies": [
		"Nothing changed.",
		"$(info) Accept or Discard 1 change.",
		"1 change",
	...
	"vs/workbench/contrib/scm/browser/scmViewPane": [
		...
		"Outgoing",
		"Outgoing changes",
		"Incoming changes from {0}",
		"Outgoing changes to {0}",
		"All Changes"
	],
	...
	"vs/workbench/contrib/terminalContrib/accessibility/browser/terminalAccessibilityHelp": [
		"The Focus Accessible Terminal View ({0}) command enables screen readers to read terminal contents.",
		"The Focus Terminal Accessible View command enables screen readers to read terminal contents and is currently not triggerable by a keybinding.",
	...
	"vs/workbench/contrib/terminalContrib/chat/browser/terminalChatWidget": [
		...
		"AI-generated commands may be incorrect"
	],
	...
	"vs/workbench/services/extensionManagement/common/extensionManagementService": [
		"Enables support for workspace specific local extensions.",
		...
		"Cannot activate, becase {0} not found"
	],
