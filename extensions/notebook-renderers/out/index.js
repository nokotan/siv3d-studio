...
function renderError(outputInfo, outputElement, ctx, trustHtml) {
    ...
    if (err.stack) {
        ...
        const stackTrace = (0, stackTraceHelper_1.formatStackTrace)(err.stack);
        ...
        const content = (0, textHelper_1.createOutputContent)(outputInfo.id, stackTrace ?? '', outputOptions);
